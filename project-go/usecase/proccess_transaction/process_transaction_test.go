...
import (
	...
	mock_broker "github.com/elvesbd/gateway/adapter/broker/mock"
	"github.com/elvesbd/gateway/domain/entity"
	mock_repository "github.com/elvesbd/gateway/domain/repository/mock"
	"github.com/golang/mock/gomock"
	"github.com/stretchr/testify/assert"
)

func TestProcessTransactions_ExecuteInvalidCreditCard(t *testing.T) {
	input := TransactionDtoInput{
		ID:                        "1",
		AccountID:                 "2",
		CreditCardNumber:          "40000000000000000",
		CreditCardName:            "Elves Brito",
...
func TestProcessTransaction_ExecuteRejectedTransaction(t *testing.T) {
	...
	expectedOutput := TransactionDtoOutput{
		ID:           "1",
		Status:       entity.REJECTED,
		ErrorMessage: "you don´t have limit transaction",
	}
